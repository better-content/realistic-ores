...
MATERIALS = {
    ...
    "iron": ("metal", "chemlib:iron_ingot", "chemlib:iron_nugget", "forge:molten_iron"),
    ...
    "copper": ("metal", "chemlib:copper_ingot", "chemlib:copper_nugget", "forge:molten_copper"),
    "sulfur": ("bulk", "chemlib:sulfur", None, None),
    "gold": ("metal", "chemlib:gold_ingot", "chemlib:gold_nugget", "forge:molten_gold"),
